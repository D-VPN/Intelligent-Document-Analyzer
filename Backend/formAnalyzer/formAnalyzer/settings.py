"""
Django settings for formAnalyzer project.
...
SECRET_KEY = 'django-insecure-!05=$u8n_(npv-mi@3l(qnxcny6_1!(wmg)58h7jhwt3+=$qjv'
...
ROOT_URLCONF = 'formAnalyzer.urls'
...
WSGI_APPLICATION = 'formAnalyzer.wsgi.application'
